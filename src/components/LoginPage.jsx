    ...
    <div className="login-page">
      ...
      <div className="login-container glass-panel animate-slide-up">
        <div className="login-logo">
          <div className="login-logo-icon" style={{ width: 90, height: 90, margin: '0 auto', borderRadius: '50%', background: '#111', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src="/logo.png" alt="Sweet Fresh" style={{ width: '80%', height: '80%', objectFit: 'contain' }} />
          </div>
